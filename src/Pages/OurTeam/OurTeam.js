        ...
        <section className='py-5 py-4' style={{ background: '#FFF8F5' }}>
            <div className='container'>
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card">
                            <img src={team1} className='img-fluid w-75' class="card-img-top" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title">Jesen Dapel</h5>
                    ...
                    <div class="col">
                        <div class="card">
                            <img src={team2} className='img-fluid w-75' class="card-img-top" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title">jeo Parker</h5>
                                <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <img src={team3} className='img-fluid w-75' class="card-img-top" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title">Newl Dipker</h5>
